...
- Su hosting **serverless** (es. Vercel) il filesystem è effimero e non c'è un processo che resta vivo: lo storico della sezione **Crescita** e lo stato della rotazione dello scraping ripartono quando l'istanza viene riciclata. Con un server persistente (VPS, container) tutto sopravvive ai riavvii del traffico; in alternativa serve uno store esterno.
