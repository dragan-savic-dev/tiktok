...
- Il conteggio **"salvati"** (quante volte i tuoi video sono stati salvati) non è esposto dalla Display API — esiste solo nella Research API riservata a ricercatori accreditati.
